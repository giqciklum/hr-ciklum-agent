# build_index.py (Versión Definitiva - Recomendada para Velocidad y Estabilidad)
...
# --- Utilidades y Procesadores de Ficheros (sin cambios, son correctos) ---
# ... (las funciones vision_extract, extract_document_title, etc. van aquí) ...
...
# --- Funciones con nombre para reemplazar Lambdas y ser compatibles con multiprocessing ---
...
if __name__ == "__main__":
    print(f"── Construyendo índice vectorial (Optimizado para Velocidad y Estabilidad) en '{PERSIST_DIR}' ──")
